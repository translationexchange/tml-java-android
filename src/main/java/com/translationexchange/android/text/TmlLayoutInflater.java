...
class TmlLayoutInflater extends LayoutInflater implements TmlActivityFactory {
    ...
    TmlLayoutInflater(LayoutInflater original, Context newContext, final boolean cloned) {
        super(original, newContext);
        mTmlTextFactory = new TmlTextFactory();
        setUpLayoutFactories(cloned);
    }

    @Override
    public LayoutInflater cloneInContext(Context newContext) {
        return new TmlLayoutInflater(this, newContext, true);
    }
    ...
    public void setFactory(Factory factory) {
        ...
        if (!(factory instanceof WrapperFactory)) {
            super.setFactory(new WrapperFactory(factory, this, mTmlTextFactory));
        } else {
    ...
    public void setFactory2(Factory2 factory2) {
        ...
        if (!(factory2 instanceof WrapperFactory2)) {
            super.setFactory2(new WrapperFactory2(factory2, mTmlTextFactory));
        } else {
    ...
    private void setPrivateFactoryInternal() {
        ...
        final Method setPrivateFactoryMethod = TmlReflectionUtils.getMethod(LayoutInflater.class, "setPrivateFactory");
    ...
    protected View onCreateView(View parent, String name, AttributeSet attrs) throws ClassNotFoundException {
        return mTmlTextFactory.onViewCreated(super.onCreateView(parent, name, attrs), getContext(), attrs);
    }
    ...
    protected View onCreateView(String name, AttributeSet attrs) throws ClassNotFoundException {
        ...
        return mTmlTextFactory.onViewCreated(view, view.getContext(), attrs);
    }
    ...
    private View createCustomViewInternal(View parent, View view, String name, Context viewContext, AttributeSet attrs) {
        ...
        if (view == null && name.indexOf('.') > -1) {
            if (mConstructorArgs == null)
                mConstructorArgs = TmlReflectionUtils.getField(LayoutInflater.class, "mConstructorArgs");

            final Object[] mConstructorArgsArr = (Object[]) TmlReflectionUtils.getValue(mConstructorArgs, this);
            ...
            TmlReflectionUtils.setValue(mConstructorArgs, this, mConstructorArgsArr);
            try {
